# Getting help with `HiCParser`

Thank you for using `HiCParser`!
...
* Bioconductor software related questions, such as bug reports and feature
  requests, should be addressed in the appropriate `Bioconductor/HiCParser`
...
* Bioconductor software usage questions should be addressed in the
  ...
  to use the
  [appropriate package tag](https://support.bioconductor.org/tag/HiCParser),
...
[search issues and pull requests](https://github.com/emaigne/HiCParser/issues)
